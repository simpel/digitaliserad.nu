...
(function($, window, document, undefined) {
    ...
    function DictIt(element, options) {
    ...
    // Avoid DictIt.prototype conflicts
    $.extend(DictIt.prototype, {
        init: function() {
            ...
            $.ajax({
                ...
                this.highlight(this.generateFlatList(data));
            });
        },
    ...
    $.fn[pluginName] = function(options) {
        return this.each(function() {
            if (!$.data(this, "plugin_" + pluginName)) {
                $.data(this, "plugin_" + pluginName, new DictIt(this, options));
            }
        });
    };
